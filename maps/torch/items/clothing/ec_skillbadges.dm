...
/obj/item/clothing/accessory/solgov/skillbadge/botany
	...
	desc = "A skill badge signifying that the bearer has passed the advanced training on handling exotic xenoflora. Informally known as 'Vine Wrangler'."
...
/obj/item/clothing/accessory/solgov/skillbadge/netgun
	...
	desc = "A skill badge signifying that the bearer has passed the advanced training on capturing alien wildlife with the netgun. Informally known as 'Xeno-Cowboy'."
	icon_state = "ec_badge_netgun"
	badgecolor = "#6a60a1"

/obj/item/clothing/accessory/solgov/skillbadge/eva
	name = "\improper Void Mobility Specialist badge"
	desc = "A skill badge signifying that the bearer has passed the advanced training on moving around in zero-g using a jetpack. Informally known as 'Zoomer'."
...
/obj/item/clothing/accessory/solgov/skillbadge/medical
	...
	desc = "A skill badge signifying that the bearer has passed the advanced training on CPR and basic medical tech. Informally known as 'Para-paramedic'."
	icon_state = "ec_badge_med"
	badgecolor = "#47799e"

/obj/item/clothing/accessory/solgov/skillbadge/mech
	name = "\improper Exosuit Specialist badge"
	desc = "A skill badge signifying that the bearer has passed the advanced training on piloting exosuits. Informally known as 'Exonaut'."
	icon_state = "ec_badge_exo"
	badgecolor = "#72763d"

/obj/item/clothing/accessory/solgov/skillbadge/electric
	name = "\improper Electrical Specialist badge"
	desc = "A skill badge signifying that the bearer has passed the advanced training on working with high-voltage electrical systems. Informally known as 'Jury-rigger'."
	icon_state = "ec_badge_electro"
	badgecolor = "#8e633f"

/obj/item/clothing/accessory/solgov/skillbadge/science
	name = "\improper Research Specialist badge"
	desc = "A skill badge signifying that the bearer has passed the advanced training on assisting in the labs and working the sensor suites. Informally known as 'Peeper'."
