...
/datum/gear/sikits/guns/New()
	..()
	var/guns = list()
	guns["Jhen Bothus Mk59"] = /obj/item/gun/projectile/pistol/military/alt/solar/loadout
	guns["Hephaestus P10"] = /obj/item/gun/projectile/pistol/military/sec
	guns["Lumoco Mk12"] = /obj/item/gun/projectile/revolver/medium/sec
