// marine patch
/obj/item/clothing/accessory/lordan/smc_patch
	name = "\improper Marine Corps patch"
	desc = "A robust shoulder patch, carrying the symbol of the Lordanian Marine Corps, or LMC for short."
	...
	check_codex_val = FACTION_LARMARINES

/obj/item/clothing/accessory/lordan/smc_patch/xeno
...
/obj/item/clothing/accessory/lordan/fleet_patch/sixth
...
/obj/item/clothing/accessory/badge/lordan/tags
	badge_string = "LRS Antares"

/obj/item/clothing/accessory/badge/lordan/tags/fleet
	badge_string = "LSSF"

/obj/item/clothing/accessory/badge/lordan/tags/marine
	badge_string = "LMC"

// custom ribbon for loadout
/obj/item/clothing/accessory/ribbon/lordan/custom
	icon_state = "ribbon_custom"
	icon = 'maps/torch/icons/obj/obj_accessories_boh.dmi'
	accessory_icons = list(slot_w_uniform_str = 'maps/torch/icons/mob/onmob_accessories_boh.dmi', slot_wear_suit_str = 'maps/torch/icons/mob/onmob_accessories_boh.dmi')

/obj/item/clothing/accessory/ribbon/lordan/custom/color
	icon_state = "ribbon_custom_color"

// explorer ranks and spec pin
/obj/item/clothing/accessory/lordan/specialty/enlisted/explorer
...
/obj/item/clothing/accessory/lordan/rank/ec/enlisted/e2
...
/obj/item/clothing/accessory/lordan/rank/fleet/warrant_officer
	icon_state = "FW0"
	overlay_state = "fleetrank_warrant_gold"

/obj/item/clothing/accessory/lordan/rank/fleet/warrant_officer/w1
	icon_state = "FW1"
	name = "ranks (W-1 junior warrant officer"
	desc = "Insignia denoting the rank of Junior Warrant Officer"

/obj/item/clothing/accessory/lordan/rank/fleet/warrant_officer/w2
	icon_state = "FW2"
	name = "ranks (W-2 chief warrant officer"
	desc = "Insignia denoting the rank of Chief Warrant Officer"

/obj/item/clothing/accessory/lordan/rank/fleet/warrant_officer/w3
	icon_state = "FW3"
...
/obj/item/clothing/accessory/lordan/rank/fleet/warrant_officer/w4
	icon_state = "FW4"
	overlay_state = "fleetrank_warrant_silver"
	name = "ranks (W-4 master chief warrant officer"
	desc = "Insignia denoting the rank of Master Chief Warrant Officer"

/obj/item/clothing/accessory/lordan/rank/fleet/warrant_officer/w5
	icon_state = "FW5"
...
/obj/item/clothing/accessory/lordan/rank/marine_corps
	icon_state = "ME0"
	name = "marine ranks"
...
/obj/item/clothing/accessory/lordan/rank/marine_corps/warrant_officer/w4
	icon_state = "MW4"
	name = "ranks (W-4 major warrant officer)"
	overlay_state = "armyrank_warrant_silver"
	desc = "Insignia denoting the rank of Major Warrant Officer"

/obj/item/clothing/accessory/lordan/rank/marine_corps/warrant_officer/w5
	icon_state = "MW5"
...
/obj/item/clothing/accessory/lordan/rank/marine_corps/flag/o8
	icon_state = "MO8"
	name = "ranks (O-8 major general)"
	desc = "Insignia denoting the rank of Major General."

/obj/item/clothing/accessory/lordan/rank/marine_corps/flag/o9
	icon_state = "MO9"
	name = "ranks (O-9 lieutenant general)"
	desc = "Insignia denoting the rank of Lieutenant General."

/obj/item/clothing/accessory/lordan/rank/marine_corps/flag/o10
	icon_state = "MO10"
