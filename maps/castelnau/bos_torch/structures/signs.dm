/obj/structure/sign/dedicationplaque
	name = "\improper SGV Dagon dedication plaque"
	icon_state = "lightplaque"

/obj/structure/sign/dedicationplaque/Initialize()
	. = ..()
	desc = "SGV Dagon - Mako Class System Surveyor - SGF Registry 95519 - Shiva Fleet Yards, Mars - First Vessel To Bear The Name - Launched 1337 - Sol Central Government - 'Never was anything great achieved without danger.'"
