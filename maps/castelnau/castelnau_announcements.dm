/datum/map/castelnau
	shuttle_called_message = "Внимание всему персоналу: ожидается прибытие челнока с оборудованием для расчистки завалов. Приблизительное время прибытия: %ETA%."
	shuttle_docked_message = "Внимание всему персоналу: челнок с оборудованием прибыл. Приблизительное время подготовки к процедуре расчистки: %ETD%."
	shuttle_leaving_dock = "Внимание всему персоналу: началась расчистка завалов. Ожидаемое время окончания первой фазы работ: %ETA%."
	shuttle_recall_message = "Внимание всему персоналу: прибытие челнока с оборудованием отменено."

	emergency_shuttle_called_message = "Внимание всему персоналу: начата процедура аварийной эвакуации судна. Незамедлительно проследуйте к спасательным капсулам в корму палубы 1 или к спасательным шаттлам в носовой док палубы 3. До разблокировки спасательных капсул осталось: %ETA%."
...
/datum/map/castelnau/level_x_biohazard_announcement(var/bio_level)
	if(!isnum(bio_level))
