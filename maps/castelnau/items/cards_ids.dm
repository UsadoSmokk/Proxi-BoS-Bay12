...
/obj/item/card/id/castelnau/silver
	desc = "A silver identification card belonging to the Coordinator of RMV Castelnau."
	job_access_type = /datum/job/hop
	detail_color = COLOR_COMMAND_BLUE

/obj/item/card/id/castelnau/gold
	desc = "A golden identification card belonging to the Captain of RMV Castelnau."
