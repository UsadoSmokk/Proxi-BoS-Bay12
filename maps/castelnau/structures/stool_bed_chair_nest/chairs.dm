...
/obj/structure/bed/sofa/on_update_icon()
	overlays.Cut()
	var/image/I = image('maps/castelnau/icons/ark/obj/furniture.dmi', "[base_icon]_over")
	I.plane = DEFAULT_PLANE
	I.layer = ABOVE_HUMAN_LAYER
	overlays |= I
	if(buckled_mob)
		var/image/D = image('maps/castelnau/icons/ark/obj/furniture.dmi', "[base_icon]_armrest")
...
/obj/structure/bed/chair/bathtub/verb/toggle()
	...
	update_icon()
	if(on)
		playsound(src, 'sound/ark/effects/bath_filling.ogg', 20)
		...
		playsound(src, 'sound/ark/effects/drain.ogg', 20)
...
/obj/structure/bed/chair/bathtub/buckle_mob()
	. = ..()
	if(. && on)
		playsound(src, 'sound/ark/effects/bathtub_splash.ogg', 20)
