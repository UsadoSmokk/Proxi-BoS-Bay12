/decl/hierarchy/outfit/job/castelnau/syndi/arbites/security
...
/decl/hierarchy/outfit/job/castelnau/syndi/army/security
...
/decl/hierarchy/outfit/job/castelnau/syndi/detective
	name = OUTFIT_JOB_NAME("SyndiDetective - Castelnau")
