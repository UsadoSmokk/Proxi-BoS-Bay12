...
#define UNRESTRICTED_SPECIES  list(SPECIES_NABBER,SPECIES_PROMETHEAN,SPECIES_YEOSA,SPECIES_HUMAN,SPECIES_DIONA,SPECIES_IPC,SPECIES_UNATHI,SPECIES_TRITONIAN,SPECIES_SPACER,SPECIES_VATGROWN,SPECIES_GRAVWORLDER,SPECIES_MULE,SPECIES_TAJ,SPECIES_SKRELL, SPECIES_SHELL) //boh
#define RESTRICTED_SPECIES    list(SPECIES_VOX,SPECIES_VOX_ARMALIS,SPECIES_ALIEN,SPECIES_GOLEM,SPECIES_MANTID_GYNE,SPECIES_MANTID_ALATE,SPECIES_MONARCH_WORKER,SPECIES_MONARCH_QUEEN) //boh
#define HUMAN_SPECIES        list(SPECIES_HUMAN, SPECIES_VATGROWN, SPECIES_SPACER, SPECIES_GRAVWORLDER, SPECIES_MULE)
#define SOUNDED_SPECIES list(SPECIES_HUMAN, SPECIES_VATGROWN, SPECIES_SPACER, SPECIES_TRITONIAN, SPECIES_GRAVWORLDER, SPECIES_MULE, SPECIES_UNATHI, SPECIES_YEOSA, SPECIES_SKRELL, SPECIES_SHELL, SPECIES_PROMETHEAN)
