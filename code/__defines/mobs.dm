...
#define UNRESTRICTED_SPECIES  list(SPECIES_NABBER,SPECIES_PROMETHEAN,SPECIES_YEOSA,SPECIES_HUMAN,SPECIES_DIONA,SPECIES_IPC,SPECIES_UNATHI,SPECIES_TRITONIAN,SPECIES_SPACER,SPECIES_VATGROWN,SPECIES_GRAVWORLDER,SPECIES_MULE,SPECIES_TAJ,SPECIES_SKRELL) //boh
