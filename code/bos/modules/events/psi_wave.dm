...
/datum/event/psi_wave/announce()
	command_announcement.Announce("В секторе Мьёльнир был зафиксирован большой скачок пси-энергии. Мы подозреваем, что на вашем корабле могли появиться новые псионики. Рекомендуем обнаружить их и зарегестрировать как можно быстрее, для уменьшения опасности их для себя и экипажа.", zlevels = affecting_z)
