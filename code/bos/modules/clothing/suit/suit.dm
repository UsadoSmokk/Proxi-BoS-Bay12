/obj/item/clothing/suit/storage/toggle/labcoat/rd/ec/lordan
	...
	desc = "A full-body research management coat. Judging by the amount of designs on it, it is only to be worn by the most enthusiastic of employees."

/obj/item/clothing/suit/storage/bos
	icon = 'icons/bos/obj/clothing/obj_suit.dmi'
	item_icons = list(slot_wear_suit_str = 'icons/bos/mob/onmob/onmob_suit.dmi')
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS

/obj/item/clothing/suit/storage/bos/hmjacket
	name = "old bomber"
