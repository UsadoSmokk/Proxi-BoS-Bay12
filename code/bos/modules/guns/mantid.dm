...
/obj/item/gun/energy/particle/special_check(var/mob/living/carbon/human/user)
	. = ..()
...
/obj/item/gun/energy/particle
	...
	icon = 'icons/bos/obj/guns/particle_rifle.dmi'
...
/obj/item/gun/energy/particle/Initialize()
	. = ..()
...
/obj/item/gun/energy/particle/small/par //MANKIND IS DEAD, BLOOD IS FUEL, HELL IS FULL.
		...
		if(bodytype in list(SPECIES_MANTID_ALATE,SPECIES_MANTID_GYNE,SPECIES_NABBER))
			if(slot == slot_l_hand_str)
				if(bodytype == SPECIES_MANTID_ALATE)
					return overlay_image('icons/bos/mob/species/mantid/onmob_lefthand_particle_rifle_alate.dmi',  item_state_slots[slot_l_hand_str], color, RESET_COLOR)
				else if(bodytype == SPECIES_MANTID_GYNE)
					return overlay_image('icons/bos/mob/species/mantid/onmob_lefthand_particle_rifle_gyne.dmi',   item_state_slots[slot_l_hand_str], color, RESET_COLOR)
				else
				...
				if(bodytype == SPECIES_MANTID_ALATE)
					return overlay_image('icons/bos/mob/species/mantid/onmob_righthand_particle_rifle_alate.dmi', item_state_slots[slot_r_hand_str], color, RESET_COLOR)
				else if(bodytype == SPECIES_MANTID_GYNE)
					return overlay_image('icons/bos/mob/species/mantid/onmob_righthand_particle_rifle_gyne.dmi',  item_state_slots[slot_r_hand_str], color, RESET_COLOR)
				else
