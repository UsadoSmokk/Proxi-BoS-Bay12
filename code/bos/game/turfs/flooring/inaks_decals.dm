/obj/effect/floor_decal/inaks
	name = "asphalt edge"
	icon = 'icons/bos/turf/inaks_decals.dmi'
	icon_state = "asphalt_edge"

/obj/effect/floor_decal/inaks/road_border
	name = "road border"
	icon_state = "road_border"

/obj/effect/floor_decal/inaks/road_border_corner
	name = "road border"
...
// CRACKS IN ASPHALT //
/obj/effect/floor_decal/inaks/asphalt_crack_1
	name = "crack in asphalt"
	icon_state = "crack_1"
