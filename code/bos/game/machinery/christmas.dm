/obj/machinery/xmaslights
	...
	icon = 'icons/bos/obj/christmas.dmi'
...
/obj/structure/sign/tinsel/New()
	..()
	if(!color)
		color = pick(COLOR_RED_LIGHT, COLOR_YELLOW, COLOR_GREEN, COLOR_BLUE, COLOR_PURPLE, COLOR_CYAN, COLOR_GOLD)
...
CREATE_TINSEL_PREFAB(cyan, COLOR_CYAN)
CREATE_TINSEL_PREFAB(green, COLOR_GREEN)
CREATE_TINSEL_PREFAB(yellow, COLOR_YELLOW)
CREATE_TINSEL_PREFAB(purple, COLOR_PURPLE)
CREATE_TINSEL_PREFAB(gold, COLOR_GOLD)
CREATE_TINSEL_PREFAB(blue, COLOR_BLUE)
