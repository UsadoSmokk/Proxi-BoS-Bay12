...
/datum/uplink_item/item/tools/money
	...
	item_cost = 65 //BoS, was 8
	path = /obj/item/storage/secure/briefcase/money
/datum/uplink_item/item/tools/money/New()
	. = ..()
	desc = "A briefcase with 5,000 untraceable [GLOB.using_map.local_currency_name]. Makes a great bribe if they're willing to take you up on your offer."
