...
/obj/item/gun/energy/particle/support/handle_post_fire(mob/user, atom/target)
	..()

/obj/item/gun/energy/particle/support/afterattack(atom/A, mob/living/user, adjacent, params)
	if(adjacent) return
...
/obj/item/gun/energy/drone_particle//near identical to standard one, just without the limit as it's not a subpath
	name = "particle lance"
...
/obj/item/gun/energy/drone_particle/on_update_icon()
	. = ..()
