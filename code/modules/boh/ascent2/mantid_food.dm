 ...
 */
/obj/item/reagent_containers/food/snacks/nutrient_cube
	name = "nutrient cube"
	desc = "... ewwww. You aren't going to eat that, are you?"
	icon = 'icons/obj/food.dmi'
	icon_state = "nutrient_cube"
/obj/item/reagent_containers/food/snacks/nutrient_cube/Initialize()
	.=..()
...
/obj/machinery/mantid_dispenser
	...
	icon = 'icons/bos/obj/machines/mantid_food.dmi'
...
/obj/machinery/mantid_dispenser/proc/spawn_nutrient_cube()
	var/obj/item/reagent_containers/food/snacks/nutrient_cube/C = new(get_turf(src))
