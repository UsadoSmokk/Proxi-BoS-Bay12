...
/mob/living/carbon/human/proc/check_obscured_slots() //BoS
...
/mob/living/carbon/human/show_inv(mob/user as mob) //BoS. Fully rewrite for better UI
...
/mob/living/carbon/human/OnTopic(mob/user, href_list)
	/*BoS shutdown this for nanoui interface
