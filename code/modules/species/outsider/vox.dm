/datum/species/vox
	...
	icobase =         'icons/bos/mob/human_races/species/vox/body.dmi'
	deform =          'icons/bos/mob/human_races/species/vox/body.dmi'
	...
	available_cultural_info = list( //boh
		TAG_CULTURE =   list(
			CULTURE_VOX_ACOLYTE,
			CULTURE_VOX_TRUTH,
...
/obj/item/vox_changer/attack_hand(mob/living/carbon/human/user)
	...
	if (!length(data))
		var/decl/cultural_info/culture = SSculture.get_culture(CULTURE_VOX_ACOLYTE) //boh
