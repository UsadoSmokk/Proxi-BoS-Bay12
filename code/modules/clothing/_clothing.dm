...
/obj/item/clothing/get_mob_overlay(mob/user_mob, slot)
	...
	if (accessories != null && islist(accessories) && accessories.len) // ORIG	if(accessories.len)
...
/obj/item/clothing/glasses
	...
	sprite_sheets = list(
		SPECIES_VOX = 'icons/bos/mob/onmob/species/vox/onmob_eyes_vox.dmi',
...
/obj/item/clothing/mask
	...
	sprite_sheets = list(
		SPECIES_VOX = 'icons/bos/mob/onmob/species/vox/onmob_mask_vox.dmi',
...
/obj/item/clothing/under
	...
	sprite_sheets = list(
		SPECIES_VOX = 'icons/bos/mob/onmob/species/vox/onmob_under_vox.dmi',
