...
/obj/effect/shuttle_landmark/proc/landmark_selected(datum/shuttle/shuttle) //boh>

/obj/effect/shuttle_landmark/proc/landmark_deselected(datum/shuttle/shuttle)

/obj/effect/shuttle_landmark/proc/shuttle_departed(datum/shuttle/shuttle) // <boh
...
//Used for custom landing locations. Self deletes after a shuttle leaves. (BOH)
