/obj/item/gun/launcher/rocket
	name = "Lumoco Faithbreaker" //boh
	desc = "Lumoco's Faithbreaker is a aptly named rocket-launcher commonly seen amongst poorer fighters and terrorists due to it's cheap and reusable nature." //boh
	icon_state = "rocket"
	item_state = "rocket"
