/obj/item/gun/energy/taser
	name = "Hephaestus Stunner" //boh
	desc = "The Hephaestus Stunner is a cheap and effective stungun designed for the Military Police!" //boh
...
/obj/item/gun/energy/taser/carbine
	name = "Hephaestus Lightning" //boh
	desc = "The Hephaestus Lightning is a powerful stunrifle built to takedown more 'biologically robust' species, such as Unathi!" //boh
...
/obj/item/gun/energy/stunrevolver
	name = "MA-Sparkler" //boh
	desc = "The Martian Armoury Sparkler. It's a stun-gun in the shape of a revolver with pitiful ammo-capacity. It's only saving grace is the stability of it's shot over distance!" //boh
...
/obj/item/gun/energy/stunrevolver/rifle
	name = "MA-Crackler" //boh
	desc = "An Martian Armoury Crackler. A vastly oversized variant of the Sparkler. Fires overcharged electrodes to obliterate pain receptors without harming them too much!" //boh
...
/obj/item/gun/energy/plasmastun
	name = "Hephaestus Selkie" //boh
	desc = "The Hephaestus Industries MA21 Selkie is a weapon that uses a laser pulse to ionise the local atmosphere, creating a disorienting pulse of plasma and deafening shockwave as the wave expands. Without a local atmosphere to ionize, however, it becomes a very expensive paperweight." //boh
