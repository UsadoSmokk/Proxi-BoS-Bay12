...
/datum/round_aspect/traps
	...
	announce_text = "<span class=\"info\">Недавно проходили учения, и после них в округе полно опасностей. Будьте осторожны!</span>"

/datum/round_aspect/traps/get_desc_msg()
	return SPAN_WARNING("Пустыни стали более опасными...")
