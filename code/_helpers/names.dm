/proc/generate_system_name()
	return "[pick("Luytens Star","Procyon", "Sirius", "Innes Star", "Alpha Centauri", "Theia", "Groombridge", "Kruger", "Barnards Star")]"
